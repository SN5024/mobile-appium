// /test/native/android/pageobjects/preference.page.js
...
export default class PreferencePage {
    ...
    async okDialogBox() {
        await this.okButton.waitForDisplayed({ timeout: 3000 });
